...
export const SYSTEM_ANALYST_QUESTIONS = [
...
export const SOFTWARE_DEVELOPER_QUESTIONS = [
...
export const WEB_AND_MULTIMEDIA_DEVELOPER_QUESTIONS = [
...
export const APPLICATIONS_PROGRAMMERS_QUESTIONS = [
