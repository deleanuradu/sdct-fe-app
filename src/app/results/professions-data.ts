import { ProfessionModel } from "@app/results/profession.model";
...
export const PROFESSIONS: ProfessionModel[] = [
  ...
  {
    name: "Industrial mobile devices software developer",
    skills: [
      "Use software libraries",
      "Develop software prototype",
      "Utilise computer-aided software engineering tools",
  ...
  {
    name: "Numerical tool and process control programmer",
    skills: [
